...
const (
	...
	// TexteditUndostatecount as defined in nk/nuklear.h:2804
	TexteditUndostatecount = 99
	// TexteditUndocharcount as defined in nk/nuklear.h:2808
	TexteditUndocharcount = 999
	// MaxLayoutRowTemplateColumns as defined in nk/nuklear.h:3806
	MaxLayoutRowTemplateColumns = 16
	// ChartMaxSlot as defined in nk/nuklear.h:3809
	ChartMaxSlot = 4
	// WindowMaxName as defined in nk/nuklear.h:3907
	WindowMaxName = 64
	// ButtonBehaviorStackSize as defined in nk/nuklear.h:4021
	ButtonBehaviorStackSize = 8
	// FontStackSize as defined in nk/nuklear.h:4025
	FontStackSize = 8
	// StyleItemStackSize as defined in nk/nuklear.h:4029
	StyleItemStackSize = 16
	// FloatStackSize as defined in nk/nuklear.h:4033
	FloatStackSize = 32
	// VectorStackSize as defined in nk/nuklear.h:4037
	VectorStackSize = 16
	// FlagsStackSize as defined in nk/nuklear.h:4041
	FlagsStackSize = 32
	// ColorStackSize as defined in nk/nuklear.h:4045
	ColorStackSize = 32
	// Float as defined in nk/nuklear.h:4059
	Float = 0
	// Pi as defined in nk/nuklear.h:4172
	Pi = 3.141592654
	// MaxFloatPrecision as defined in nk/nuklear.h:4174
	MaxFloatPrecision = 2
)
...
// AntiAliasing as declared in nk/nuklear.h:970
type AntiAliasing int32

// AntiAliasing enumeration from nk/nuklear.h:970
const (
	AntiAliasingOff = iota
	AntiAliasingOn  = 1
)

// ConvertResult as declared in nk/nuklear.h:971
type ConvertResult int32

// ConvertResult enumeration from nk/nuklear.h:971
const (
	ConvertSuccess           = iota
...
// PanelFlags as declared in nk/nuklear.h:1174
type PanelFlags int32

// PanelFlags enumeration from nk/nuklear.h:1174
const (
	WindowBorder         = (1 << (0))
	WindowMovable        = (1 << (1))
	WindowScalable       = (1 << (2))
...
// WidgetLayoutStates as declared in nk/nuklear.h:1831
type WidgetLayoutStates int32

// WidgetLayoutStates enumeration from nk/nuklear.h:1831
const (
	WidgetInvalid = iota
	WidgetValid   = 1
	WidgetRom     = 2
...
// WidgetStates as declared in nk/nuklear.h:1836
type WidgetStates int32

// WidgetStates enumeration from nk/nuklear.h:1836
const (
...
// TextAlign as declared in nk/nuklear.h:1862
type TextAlign int32

// TextAlign enumeration from nk/nuklear.h:1862
const (
	TextAlignLeft     = 0x01
...
// TextAlignment as declared in nk/nuklear.h:1870
type TextAlignment int32

// TextAlignment enumeration from nk/nuklear.h:1870
const (
...
// EditFlags as declared in nk/nuklear.h:1997
type EditFlags int32

// EditFlags enumeration from nk/nuklear.h:1997
const (
	EditDefault            = iota
	EditReadOnly           = (1 << (0))
	EditAutoSelect         = (1 << (1))
...
// EditTypes as declared in nk/nuklear.h:2012
type EditTypes int32

// EditTypes enumeration from nk/nuklear.h:2012
const (
...
// EditEvents as declared in nk/nuklear.h:2018
type EditEvents int32

// EditEvents enumeration from nk/nuklear.h:2018
const (
	EditActive      = (1 << (0))
	EditInactive    = (1 << (1))
	EditActivated   = (1 << (2))
...
// StyleColors as declared in nk/nuklear.h:2137
type StyleColors int32

// StyleColors enumeration from nk/nuklear.h:2137
const (
	ColorText                  = iota
	ColorWindow                = 1
	ColorHeader                = 2
...
// StyleCursor as declared in nk/nuklear.h:2168
type StyleCursor int32

// StyleCursor enumeration from nk/nuklear.h:2168
const (
	CursorArrow                  = iota
	CursorText                   = 1
	CursorMove                   = 2
...
// FontCoordType as declared in nk/nuklear.h:2498
type FontCoordType int32

// FontCoordType enumeration from nk/nuklear.h:2498
const (
	CoordUv    = iota
	CoordPixel = 1
)

// FontAtlasFormat as declared in nk/nuklear.h:2569
type FontAtlasFormat int32

// FontAtlasFormat enumeration from nk/nuklear.h:2569
const (
	FontAtlasAlpha8 = iota
	FontAtlasRgba32 = 1
)

// AllocationType as declared in nk/nuklear.h:2666
type AllocationType int32

// AllocationType enumeration from nk/nuklear.h:2666
const (
	BufferFixed   = iota
	BufferDynamic = 1
)

// BufferAllocationType as declared in nk/nuklear.h:2671
type BufferAllocationType int32

// BufferAllocationType enumeration from nk/nuklear.h:2671
const (
	BufferFront = iota
	BufferBack  = 1
	BufferMax   = 2
...
// TextEditType as declared in nk/nuklear.h:2834
type TextEditType int32

// TextEditType enumeration from nk/nuklear.h:2834
const (
	TextEditSingleLine = iota
	TextEditMultiLine  = 1
)

// TextEditMode as declared in nk/nuklear.h:2839
type TextEditMode int32

// TextEditMode enumeration from nk/nuklear.h:2839
const (
...
// CommandType as declared in nk/nuklear.h:2939
type CommandType int32

// CommandType enumeration from nk/nuklear.h:2939
const (
	CommandTypeNop            = iota
...
// CommandClipping as declared in nk/nuklear.h:3122
type CommandClipping int32

// CommandClipping enumeration from nk/nuklear.h:3122
const (
	ClippingOff = False
	ClippingOn  = True
)

// DrawListStroke as declared in nk/nuklear.h:3231
type DrawListStroke int32

// DrawListStroke enumeration from nk/nuklear.h:3231
const (
	StrokeOpen   = False
	StrokeClosed = True
)

// DrawVertexLayoutAttribute as declared in nk/nuklear.h:3238
type DrawVertexLayoutAttribute int32

// DrawVertexLayoutAttribute enumeration from nk/nuklear.h:3238
const (
	VertexPosition       = iota
	VertexColor          = 1
	VertexTexcoord       = 2
...
// DrawVertexLayoutFormat as declared in nk/nuklear.h:3245
type DrawVertexLayoutFormat int32

// DrawVertexLayoutFormat enumeration from nk/nuklear.h:3245
const (
	FormatSchar              = iota
	FormatSshort             = 1
	FormatSint               = 2
...
// StyleItemType as declared in nk/nuklear.h:3365
type StyleItemType int32

// StyleItemType enumeration from nk/nuklear.h:3365
const (
	StyleItemColor = iota
	StyleItemImage = 1
)

// StyleHeaderAlign as declared in nk/nuklear.h:3706
type StyleHeaderAlign int32

// StyleHeaderAlign enumeration from nk/nuklear.h:3706
const (
	HeaderLeft  = iota
	HeaderRight = 1
)

// PanelType as declared in nk/nuklear.h:3812
type PanelType int32

// PanelType enumeration from nk/nuklear.h:3812
const (
	PanelWindow     = (1 << (0))
	PanelGroup      = (1 << (1))
	PanelPopup      = (1 << (2))
...
// PanelSet as declared in nk/nuklear.h:3821
type PanelSet int32

// PanelSet enumeration from nk/nuklear.h:3821
const (
...
// PanelRowLayoutType as declared in nk/nuklear.h:3843
type PanelRowLayoutType int32

// PanelRowLayoutType enumeration from nk/nuklear.h:3843
const (
...
// WindowFlags as declared in nk/nuklear.h:3911
type WindowFlags int32

// WindowFlags enumeration from nk/nuklear.h:3911
const (
	WindowPrivate        = (1 << (11))
