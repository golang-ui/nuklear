...
const (
	...
	// TexteditUndostatecount as defined in nk/nuklear.h:2658
	TexteditUndostatecount = 99
	// TexteditUndocharcount as defined in nk/nuklear.h:2662
	TexteditUndocharcount = 999
	// MaxLayoutRowTemplateColumns as defined in nk/nuklear.h:3658
	MaxLayoutRowTemplateColumns = 16
	// ChartMaxSlot as defined in nk/nuklear.h:3661
	ChartMaxSlot = 4
	// WindowMaxName as defined in nk/nuklear.h:3758
	WindowMaxName = 64
	// ButtonBehaviorStackSize as defined in nk/nuklear.h:3872
	ButtonBehaviorStackSize = 8
	// FontStackSize as defined in nk/nuklear.h:3876
	FontStackSize = 8
	// StyleItemStackSize as defined in nk/nuklear.h:3880
	StyleItemStackSize = 16
	// FloatStackSize as defined in nk/nuklear.h:3884
	FloatStackSize = 32
	// VectorStackSize as defined in nk/nuklear.h:3888
	VectorStackSize = 16
	// FlagsStackSize as defined in nk/nuklear.h:3892
	FlagsStackSize = 32
	// ColorStackSize as defined in nk/nuklear.h:3896
	ColorStackSize = 32
	// Float as defined in nk/nuklear.h:3910
	Float = 0
	// Pi as defined in nk/nuklear.h:4023
	Pi = 3.141592654
	// MaxFloatPrecision as defined in nk/nuklear.h:4025
	MaxFloatPrecision = 2
)
...
// AntiAliasing as declared in nk/nuklear.h:968
type AntiAliasing int32

// AntiAliasing enumeration from nk/nuklear.h:968
const (
	AntiAliasingOff = iota
	AntiAliasingOn  = 1
)

// ConvertResult as declared in nk/nuklear.h:969
type ConvertResult int32

// ConvertResult enumeration from nk/nuklear.h:969
const (
	ConvertSuccess           = iota
...
// PanelFlags as declared in nk/nuklear.h:1172
type PanelFlags int32

// PanelFlags enumeration from nk/nuklear.h:1172
const (
	WindowBorder         = (1 << (0))
	WindowMovable        = (1 << (1))
	WindowScalable       = (1 << (2))
...
// WidgetLayoutStates as declared in nk/nuklear.h:1684
type WidgetLayoutStates int32

// WidgetLayoutStates enumeration from nk/nuklear.h:1684
const (
	WidgetInvalid = iota
	WidgetValid   = 1
	WidgetRom     = 2
...
// WidgetStates as declared in nk/nuklear.h:1689
type WidgetStates int32

// WidgetStates enumeration from nk/nuklear.h:1689
const (
...
// TextAlign as declared in nk/nuklear.h:1715
type TextAlign int32

// TextAlign enumeration from nk/nuklear.h:1715
const (
	TextAlignLeft     = 0x01
...
// TextAlignment as declared in nk/nuklear.h:1723
type TextAlignment int32

// TextAlignment enumeration from nk/nuklear.h:1723
const (
...
// EditFlags as declared in nk/nuklear.h:1851
type EditFlags int32

// EditFlags enumeration from nk/nuklear.h:1851
const (
	EditDefault            = iota
	EditReadOnly           = (1 << (0))
	EditAutoSelect         = (1 << (1))
...
// EditTypes as declared in nk/nuklear.h:1866
type EditTypes int32

// EditTypes enumeration from nk/nuklear.h:1866
const (
...
// EditEvents as declared in nk/nuklear.h:1872
type EditEvents int32

// EditEvents enumeration from nk/nuklear.h:1872
const (
	EditActive      = (1 << (0))
	EditInactive    = (1 << (1))
	EditActivated   = (1 << (2))
...
// StyleColors as declared in nk/nuklear.h:1991
type StyleColors int32

// StyleColors enumeration from nk/nuklear.h:1991
const (
	ColorText                  = iota
	ColorWindow                = 1
	ColorHeader                = 2
...
// StyleCursor as declared in nk/nuklear.h:2022
type StyleCursor int32

// StyleCursor enumeration from nk/nuklear.h:2022
const (
	CursorArrow                  = iota
	CursorText                   = 1
	CursorMove                   = 2
...
// FontCoordType as declared in nk/nuklear.h:2352
type FontCoordType int32

// FontCoordType enumeration from nk/nuklear.h:2352
const (
	CoordUv    = iota
	CoordPixel = 1
)

// FontAtlasFormat as declared in nk/nuklear.h:2423
type FontAtlasFormat int32

// FontAtlasFormat enumeration from nk/nuklear.h:2423
const (
	FontAtlasAlpha8 = iota
	FontAtlasRgba32 = 1
)

// AllocationType as declared in nk/nuklear.h:2520
type AllocationType int32

// AllocationType enumeration from nk/nuklear.h:2520
const (
	BufferFixed   = iota
	BufferDynamic = 1
)

// BufferAllocationType as declared in nk/nuklear.h:2525
type BufferAllocationType int32

// BufferAllocationType enumeration from nk/nuklear.h:2525
const (
	BufferFront = iota
	BufferBack  = 1
	BufferMax   = 2
...
// TextEditType as declared in nk/nuklear.h:2688
type TextEditType int32

// TextEditType enumeration from nk/nuklear.h:2688
const (
	TextEditSingleLine = iota
	TextEditMultiLine  = 1
)

// TextEditMode as declared in nk/nuklear.h:2693
type TextEditMode int32

// TextEditMode enumeration from nk/nuklear.h:2693
const (
...
// CommandType as declared in nk/nuklear.h:2793
type CommandType int32

// CommandType enumeration from nk/nuklear.h:2793
const (
	CommandTypeNop            = iota
...
// CommandClipping as declared in nk/nuklear.h:2976
type CommandClipping int32

// CommandClipping enumeration from nk/nuklear.h:2976
const (
	ClippingOff = False
	ClippingOn  = True
)

// DrawListStroke as declared in nk/nuklear.h:3085
type DrawListStroke int32

// DrawListStroke enumeration from nk/nuklear.h:3085
const (
	StrokeOpen   = False
	StrokeClosed = True
)

// DrawVertexLayoutAttribute as declared in nk/nuklear.h:3092
type DrawVertexLayoutAttribute int32

// DrawVertexLayoutAttribute enumeration from nk/nuklear.h:3092
const (
	VertexPosition       = iota
	VertexColor          = 1
	VertexTexcoord       = 2
...
// DrawVertexLayoutFormat as declared in nk/nuklear.h:3099
type DrawVertexLayoutFormat int32

// DrawVertexLayoutFormat enumeration from nk/nuklear.h:3099
const (
	FormatSchar              = iota
	FormatSshort             = 1
	FormatSint               = 2
...
// StyleItemType as declared in nk/nuklear.h:3218
type StyleItemType int32

// StyleItemType enumeration from nk/nuklear.h:3218
const (
	StyleItemColor = iota
	StyleItemImage = 1
)

// StyleHeaderAlign as declared in nk/nuklear.h:3559
type StyleHeaderAlign int32

// StyleHeaderAlign enumeration from nk/nuklear.h:3559
const (
	HeaderLeft  = iota
	HeaderRight = 1
)

// PanelType as declared in nk/nuklear.h:3664
type PanelType int32

// PanelType enumeration from nk/nuklear.h:3664
const (
	PanelWindow     = (1 << (0))
	PanelGroup      = (1 << (1))
	PanelPopup      = (1 << (2))
...
// PanelSet as declared in nk/nuklear.h:3673
type PanelSet int32

// PanelSet enumeration from nk/nuklear.h:3673
const (
...
// PanelRowLayoutType as declared in nk/nuklear.h:3695
type PanelRowLayoutType int32

// PanelRowLayoutType enumeration from nk/nuklear.h:3695
const (
...
// WindowFlags as declared in nk/nuklear.h:3762
type WindowFlags int32

// WindowFlags enumeration from nk/nuklear.h:3762
const (
	WindowPrivate        = (1 << (11))
