...
func pluginFilter1DF5F22C(carg0 *C.struct_nk_text_edit, cunicode C.nk_rune) C.nk_bool {
	if pluginFilter1DF5F22CFunc != nil {
		...
		ret, _ := (C.nk_bool)(ret1df5f22c), cgoAllocsUnknown
		return ret
	}
	panic("callback func has not been set (race?)")
}
...
func pluginCopy9EA6C143(carg0 C.nk_handle, carg1 *C.char, clen C.int) {
	if pluginCopy9EA6C143Func != nil {
		...
		arg19ea6c143 := (*byte)(unsafe.Pointer(carg1))
...
func textWidthF67477C0(carg0 C.nk_handle, ch C.float, carg2 *C.char, clen C.int) C.float {
	if textWidthF67477C0Func != nil {
		...
		h67477c0 := (float32)(ch)
		arg267477c0 := (*byte)(unsafe.Pointer(carg2))
...
func (s *BufferMarker) GetActive() *Bool {
	var ret *Bool
	ret = (*Bool)(unsafe.Pointer(&s.active))
	return ret
}
...
func (x *ConvertConfig) PassRef() (*C.struct_nk_convert_config, *cgoAllocMap) {
	...
	var ctex_null_allocs *cgoAllocMap
	ref82bf4c25.tex_null, ctex_null_allocs = *(*C.struct_nk_draw_null_texture)(unsafe.Pointer(&x.TexNull)), cgoAllocsUnknown
	allocs82bf4c25.Borrow(ctex_null_allocs)
...
func (x *ConvertConfig) Deref() {
	...
	x.TexNull = *(*DrawNullTexture)(unsafe.Pointer(&x.ref82bf4c25.tex_null))
...
// GetW returns a reference to C object within a struct
func (s *Image) GetW() *Ushort {
	var ret *Ushort
	ret = (*Ushort)(unsafe.Pointer(&s.w))
	return ret
}

// GetH returns a reference to C object within a struct
func (s *Image) GetH() *Ushort {
	var ret *Ushort
	ret = (*Ushort)(unsafe.Pointer(&s.h))
	return ret
}

// GetRegion returns a reference to C object within a struct
func (s *Image) GetRegion() [4]Ushort {
	var ret [4]Ushort
	ret = *(*[4]Ushort)(unsafe.Pointer(&s.region))
	return ret
}
...
func (s *Key) GetDown() *Bool {
	var ret *Bool
	ret = (*Bool)(unsafe.Pointer(&s.down))
	return ret
}
...
func (x *NineSlice) Ref() *C.struct_nk_nine_slice {
	...
	return (*C.struct_nk_nine_slice)(unsafe.Pointer(x))
}
...
func NewNineSliceRef(ref unsafe.Pointer) *NineSlice {
	return (*NineSlice)(ref)
}

// NewNineSlice allocates a new C object of this type and converts the reference into
// a raw struct reference without wrapping.
func NewNineSlice() *NineSlice {
	return (*NineSlice)(allocStructNkNineSliceMemory(1))
}

// allocStructNkNineSliceMemory allocates memory for type C.struct_nk_nine_slice in C.
// The caller is responsible for freeing the this memory via C.free.
func allocStructNkNineSliceMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfStructNkNineSliceValue))
	if mem == nil {
		panic(fmt.Sprintln("memory alloc error: ", err))
	}
	return mem
...
const sizeOfStructNkNineSliceValue = unsafe.Sizeof([1]C.struct_nk_nine_slice{})

// PassRef returns a reference to C object as it is or allocates a new C object of this type.
func (x *NineSlice) PassRef() *C.struct_nk_nine_slice {
	if x == nil {
		x = (*NineSlice)(allocStructNkNineSliceMemory(1))
	}
	return (*C.struct_nk_nine_slice)(unsafe.Pointer(x))
}
...
// GetL returns a reference to C object within a struct
func (s *NineSlice) GetL() *Ushort {
	var ret *Ushort
	ret = (*Ushort)(unsafe.Pointer(&s.l))
	return ret
}

// GetT returns a reference to C object within a struct
func (s *NineSlice) GetT() *Ushort {
	var ret *Ushort
	ret = (*Ushort)(unsafe.Pointer(&s.t))
	return ret
}
...
// copyPEnumBytes copies the data from Go slice as *C.enum_.
func copyPEnumBytes(slice *sliceHeader) (*C.enum_, *cgoAllocMap) {
	allocs := new(cgoAllocMap)
	defer runtime.SetFinalizer(allocs, func(a *cgoAllocMap) {
		go a.Free()
	})
	...
	return (*C.enum_)(mem0), allocs
}

// allocEnumMemory allocates memory for type C.enum_ in C.
// The caller is responsible for freeing the this memory via C.free.
...
const sizeOfEnumValue = unsafe.Sizeof([1]C.enum_{})

// copyPBoolBytes copies the data from Go slice as *C.nk_bool.
func copyPBoolBytes(slice *sliceHeader) (*C.nk_bool, *cgoAllocMap) {
	allocs := new(cgoAllocMap)
	defer runtime.SetFinalizer(allocs, func(a *cgoAllocMap) {
		go a.Free()
	})
	...
	return (*C.nk_bool)(mem0), allocs
}

// allocBoolMemory allocates memory for type C.nk_bool in C.
// The caller is responsible for freeing the this memory via C.free.
...
const sizeOfBoolValue = unsafe.Sizeof([1]C.nk_bool{})
...
// copyPStructNkColorBytes copies the data from Go slice as *C.struct_nk_color.
func copyPStructNkColorBytes(slice *sliceHeader) (*C.struct_nk_color, *cgoAllocMap) {
	allocs := new(cgoAllocMap)
	defer runtime.SetFinalizer(allocs, func(a *cgoAllocMap) {
		go a.Free()
	})
	...
	mem0 := unsafe.Pointer(C.CBytes(*(*[]byte)(unsafe.Pointer(&sliceHeader{
		Data: slice.Data,
		Len:  int(sizeOfStructNkColorValue) * slice.Len,
		Cap:  int(sizeOfStructNkColorValue) * slice.Len,
	}))))
	allocs.Add(mem0)

	return (*C.struct_nk_color)(mem0), allocs
}
...
// copyPByteBytes copies the data from Go slice as *C.nk_byte.
func copyPByteBytes(slice *sliceHeader) (*C.nk_byte, *cgoAllocMap) {
	allocs := new(cgoAllocMap)
	defer runtime.SetFinalizer(allocs, func(a *cgoAllocMap) {
		go a.Free()
	})
	...
	return (*C.nk_byte)(mem0), allocs
}

// allocByteMemory allocates memory for type C.nk_byte in C.
// The caller is responsible for freeing the this memory via C.free.
...
const sizeOfByteValue = unsafe.Sizeof([1]C.nk_byte{})

// copyPStructNkFontConfigBytes copies the data from Go slice as *C.struct_nk_font_config.
func copyPStructNkFontConfigBytes(slice *sliceHeader) (*C.struct_nk_font_config, *cgoAllocMap) {
	allocs := new(cgoAllocMap)
	defer runtime.SetFinalizer(allocs, func(a *cgoAllocMap) {
		go a.Free()
	})
	...
	mem0 := unsafe.Pointer(C.CBytes(*(*[]byte)(unsafe.Pointer(&sliceHeader{
		Data: slice.Data,
		Len:  int(sizeOfStructNkFontConfigValue) * slice.Len,
		Cap:  int(sizeOfStructNkFontConfigValue) * slice.Len,
	}))))
	allocs.Add(mem0)

	return (*C.struct_nk_font_config)(mem0), allocs
}

// copyPStructNkBufferBytes copies the data from Go slice as *C.struct_nk_buffer.
func copyPStructNkBufferBytes(slice *sliceHeader) (*C.struct_nk_buffer, *cgoAllocMap) {
	allocs := new(cgoAllocMap)
	defer runtime.SetFinalizer(allocs, func(a *cgoAllocMap) {
		go a.Free()
	})
	...
	mem0 := unsafe.Pointer(C.CBytes(*(*[]byte)(unsafe.Pointer(&sliceHeader{
		Data: slice.Data,
		Len:  int(sizeOfStructNkBufferValue) * slice.Len,
		Cap:  int(sizeOfStructNkBufferValue) * slice.Len,
	}))))
	allocs.Add(mem0)

	return (*C.struct_nk_buffer)(mem0), allocs
}
