...
func (x *ConfigStackFloatElement) Deref() {
	...
	hxf95e7c8 := (*sliceHeader)(unsafe.Pointer(&x.Address))
	hxf95e7c8.Data = uintptr(unsafe.Pointer(&x.ref48484a2.address))
...
func (x *ConfigStackFlagsElement) Deref() {
	...
	hxff2234b := (*sliceHeader)(unsafe.Pointer(&x.Address))
	hxff2234b.Data = uintptr(unsafe.Pointer(&x.ref3f8db22a.address))
...
func (x *ConfigStackButtonBehaviorElement) Deref() {
	...
	hxff73280.Data = uintptr(unsafe.Pointer(&x.ref485b597.address))
...
func (x *RowLayout) Deref() {
	...
	hxfa9955c := (*sliceHeader)(unsafe.Pointer(&x.Ratio))
	hxfa9955c.Data = uintptr(unsafe.Pointer(&x.ref3c76e5b1.ratio))
...
func (x *ConvertConfig) Deref() {
	...
	hxfa3f05c := (*sliceHeader)(unsafe.Pointer(&x.VertexLayout))
	hxfa3f05c.Data = uintptr(unsafe.Pointer(&x.ref82bf4c25.vertex_layout))
