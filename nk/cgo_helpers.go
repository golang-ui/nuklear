...
func queryFontGlyphF5BA87240(chandle C.nk_handle, cfontHeight C.float, cglyph *C.struct_nk_user_font_glyph, ccodepoint C.nk_rune, cnextCodepoint C.nk_rune) {
	if queryFontGlyphF5BA87240Func != nil {
		...
		glyph5ba87240 := (*UserFontGlyph)(unsafe.Pointer(cglyph))
...
func (x *ConfigStackUserFontElement) PassRef() (*C.struct_nk_config_stack_user_font_element, *cgoAllocMap) {
	...
	ref5572630c.address, caddress_allocs = *(***C.struct_nk_user_font)(unsafe.Pointer(&x.Address)), cgoAllocsUnknown
	allocs5572630c.Borrow(caddress_allocs)

	var cold_value_allocs *cgoAllocMap
	ref5572630c.old_value, cold_value_allocs = *(**C.struct_nk_user_font)(unsafe.Pointer(&x.OldValue)), cgoAllocsUnknown
...
func (x *ConfigStackUserFontElement) Deref() {
	...
	x.Address = (**UserFont)(unsafe.Pointer(x.ref5572630c.address))
	x.OldValue = (*UserFont)(unsafe.Pointer(x.ref5572630c.old_value))
}
...
func (x *UserFont) PassRef() (*C.struct_nk_user_font, *cgoAllocMap) {
	...
	ref738ce62e.width, cwidth_allocs = (*[0]byte)(unsafe.Pointer(&x.Width)), cgoAllocsUnknown
...
func (x *ConvertConfig) Ref() *C.struct_nk_convert_config {
	...
	return (*C.struct_nk_convert_config)(unsafe.Pointer(x))
}
...
// NewConvertConfigRef converts the C object reference into a raw struct reference without wrapping.
func NewConvertConfigRef(ref unsafe.Pointer) *ConvertConfig {
	return (*ConvertConfig)(ref)
}

// NewConvertConfig allocates a new C object of this type and converts the reference into
// a raw struct reference without wrapping.
func NewConvertConfig() *ConvertConfig {
	return (*ConvertConfig)(allocStructNkConvertConfigMemory(1))
}
...
// PassRef returns a reference to C object as it is or allocates a new C object of this type.
func (x *ConvertConfig) PassRef() *C.struct_nk_convert_config {
	if x == nil {
		x = (*ConvertConfig)(allocStructNkConvertConfigMemory(1))
	}
	return (*C.struct_nk_convert_config)(unsafe.Pointer(x))
}
...
func (x *ConfigStackUserFont) PassRef() (*C.struct_nk_config_stack_user_font, *cgoAllocMap) {
	...
	refa664861d.elements, celements_allocs = *(*[8]C.struct_nk_config_stack_user_font_element)(unsafe.Pointer(&x.Elements)), cgoAllocsUnknown
...
func (x *ConfigStackUserFont) Deref() {
	...
	x.Elements = *(*[8]ConfigStackUserFontElement)(unsafe.Pointer(&x.refa664861d.elements))
}
...
func NewDrawVertexLayoutElementRef(ref unsafe.Pointer) *DrawVertexLayoutElement {
	return (*DrawVertexLayoutElement)(ref)
}
