...
// WARNING: This file has automatically been generated on Tue, 10 Sep 2019 14:00:41 CST.
...
func NkWindowGetScroll(arg0 *Context, offsetX *Uint, offsetY *Uint) {
	carg0, _ := (*C.struct_nk_context)(unsafe.Pointer(arg0)), cgoAllocsUnknown
	coffsetX, _ := (*C.nk_uint)(unsafe.Pointer(offsetX)), cgoAllocsUnknown
	coffsetY, _ := (*C.nk_uint)(unsafe.Pointer(offsetY)), cgoAllocsUnknown
...
func NkWindowSetScroll(arg0 *Context, offsetX Uint, offsetY Uint) {
	carg0, _ := (*C.struct_nk_context)(unsafe.Pointer(arg0)), cgoAllocsUnknown
	coffsetX, _ := (C.nk_uint)(offsetX), cgoAllocsUnknown
	coffsetY, _ := (C.nk_uint)(offsetY), cgoAllocsUnknown
...
func NkGroupScrolledBegin(arg0 *Context, off *Scroll, title string, arg3 Flags) int32 {
	carg0, _ := (*C.struct_nk_context)(unsafe.Pointer(arg0)), cgoAllocsUnknown
	coff, _ := (*C.struct_nk_scroll)(unsafe.Pointer(off)), cgoAllocsUnknown
	title = safeString(title)
	ctitle, _ := unpackPCharString(title)
	carg3, _ := (C.nk_flags)(arg3), cgoAllocsUnknown
...
func NkGroupSetScroll(arg0 *Context, id string, xOffset Uint, yOffset Uint) {
	...
	id = safeString(id)
	cid, _ := unpackPCharString(id)
	cxOffset, _ := (C.nk_uint)(xOffset), cgoAllocsUnknown
	cyOffset, _ := (C.nk_uint)(yOffset), cgoAllocsUnknown
...
func NkColorPicker(arg0 *Context, arg1 Colorf, arg2 ColorFormat) Colorf {
	carg0, _ := (*C.struct_nk_context)(unsafe.Pointer(arg0)), cgoAllocsUnknown
	carg1, _ := *(*C.struct_nk_colorf)(unsafe.Pointer(&arg1)), cgoAllocsUnknown
...
func NkRgbCf(c Colorf) Color {
	cc, _ := *(*C.struct_nk_colorf)(unsafe.Pointer(&c)), cgoAllocsUnknown
...
func NkHsvaColorfv(c *float32) Colorf {
	cc, _ := (*C.float)(unsafe.Pointer(c)), cgoAllocsUnknown
...
func NkColorfHsvaF(outH *float32, outS *float32, outV *float32, outA *float32, in Colorf) {
	...
	cin, _ := *(*C.struct_nk_colorf)(unsafe.Pointer(&in)), cgoAllocsUnknown
